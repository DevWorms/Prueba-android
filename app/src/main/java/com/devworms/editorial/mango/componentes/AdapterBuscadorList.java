...
public final class AdapterBuscadorList extends RecyclerView.Adapter<AdapterBuscadorList.ViewHolder> {

    private List<ParseObject> lItems;
    private List<String>lTipos;


    public AdapterBuscadorList(List<ParseObject> mItems, List<String>lTipos) {
        this.lItems = mItems;
        this.lTipos = lTipos;
    ...
    @Override
    public AdapterBuscadorList.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.objReceta = lItems.get(position);
        holder.tipoMenu = lTipos.get(position);

        holder.mTargetImageView.loadImage(lItems.get(position).getString("Url_Imagen"), spec.getKey());
    }
